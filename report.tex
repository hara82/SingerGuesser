...
As for input, a title and lyrics of a song combined were used for the input because a title tends to be too short.


\subsection{a) Documents assigned to each cluster}
K-mean clustering was conducted with k=5.
The first 120 characters of 1 documents in each cluster are shown in Table 1.
...
\begin{table}[htb]
\begin{center}
\caption{1 document in each cluster and another song}
...
\begin{figure}[htbp]
  \begin{center}
  \includegraphics[width=90mm]{figures/confusion_mat2.png}
...
\begin{figure}[htbp]
  \begin{center}
  \includegraphics[width=100mm]{figures/confusion_mat_on_test.png}
  \caption{confusion matrix}
  \end{center}
\end{figure}
